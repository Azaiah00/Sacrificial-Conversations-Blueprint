...
const deliverables = [
  { id: 1, title: "The New Standard", subtitle: "Banner Architecture", type: "Branding", image: "/assets/new-banner-concept.png", colSpan: "col-span-2 row-span-2" },
  { id: 2, title: "High-Emotion Trigger", subtitle: "Thumbnail Variant A", type: "Packaging", image: "/assets/thumbnail-concepts.png", colSpan: "col-span-1" },
  { id: 3, title: "Social Disruptor", subtitle: "Instagram/FB Ad", type: "Marketing", image: "/assets/social-ad-concept.png", colSpan: "col-span-1" },
  { id: 4, title: "Vertical Velocity", subtitle: "Shorts Template", type: "Production", image: "/assets/shorts-mockup.png", colSpan: "col-span-1" },
  { id: 5, title: "Cinematic Poster", subtitle: "Video Trailer", type: "Advertising", image: "/assets/video-poster.png", colSpan: "col-span-1" },
  { id: 6, title: "Event Activation", subtitle: "Flyer Design", type: "Print/Digital", image: "/assets/marketing-flyer.png", colSpan: "col-span-1" },
  { id: 7, title: "Brand Identity", subtitle: "Logo System", type: "Branding", image: "/assets/new-logo-concept.png", colSpan: "col-span-1" },
];
    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-zinc-950 border-t border-zinc-900">
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-zinc-800 pb-8">
        <div>
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-white uppercase tracking-tight">Visual Authority <br />Architecture</h2>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-1 auto-rows-[250px]">
